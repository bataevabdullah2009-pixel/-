...
- Telegram data-check-string сортируется детерминированно по ключам без locale-dependent comparator; тесты включают фиксированный Mini App fixture с `signature` и `photo_url`.
