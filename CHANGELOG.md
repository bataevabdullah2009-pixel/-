...
- Уточнена область применения `.Agent.skills/SKILL.md`: skill должен срабатывать только для задач внутри текущего workspace и не использоваться для несвязанных задач.
