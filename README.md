...
Главный вход в документацию: [docs/INDEX.md](docs/INDEX.md). Главный системный документ проекта: [docs/specs/global.md](docs/specs/global.md).
...
Подробные правила продукта, статусов, подтверждения, отмены, аналитики и приёмки описаны в [глобальной спецификации](docs/specs/global.md).
...
2. [docs/specs/global.md](docs/specs/global.md) - полный системный документ.
