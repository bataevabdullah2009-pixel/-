...
Актуальный контракт авторизации описан в [../../specs/technical/auth-and-shop-isolation.md](../../specs/technical/auth-and-shop-isolation.md). Этот документ фиксирует этап, на котором WebApp начал работать как Telegram Mini App с проверкой initData.
...
1. [Авторизация и изоляция магазина](../../specs/technical/auth-and-shop-isolation.md).
2. [Сессия Telegram WebApp](../../specs/technical/telegram-webapp-session.md).
3. [Роли и доступ](../../specs/product/roles-and-access.md).
