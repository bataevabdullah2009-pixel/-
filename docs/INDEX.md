...
Пользовательские контракты ручной проверки и отчёта описаны отдельно: [ручная проверка](features/manual-review.md) и [отчёт о продажах](features/sales-report.md).
