...
4. [Глобальная спецификация](./specs/global.md) - назначение, роли, owner/fallback-доступ, серверные границы, сценарии, статусы, проверка, подтверждение, отмена, аналитика, ошибки, release gate и приёмка.
