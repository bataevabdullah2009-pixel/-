...
- Сомнительные voice-записи подтверждаются или отменяются Telegram inline-кнопками либо во вкладке «Проверка».
...
- Карточки товаров редактируются inline; review edit сохраняет поля, а confirm выполняется отдельным явным действием.
