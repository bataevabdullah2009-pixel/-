...
- Сомнительные voice-записи подтверждаются или отменяются только Telegram inline-кнопками.
...
- Карточки товаров редактируются inline; review edit сохраняет поля, а confirm выполняется только в Telegram.
