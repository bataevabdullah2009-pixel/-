...
- Сомнительные voice-записи получают `needs_review` и Telegram inline-кнопки `✅ Подтвердить` / `❌ Отмена`.
...
- WebApp не показывает кнопки подтверждения/отмены review-записи.
- Журнал записей показывает дату/время, продавца, текст, статус, сумму, аудио и раскрытие товаров.
- Страница продавцов показывает активность, количество записей и выручку за период.
