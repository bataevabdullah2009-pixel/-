...
Интерфейс рассчитан на Telegram Mini App: компактная навигация, карточки отчёта и формы с крупными действиями. Бот открывает его через inline или нижнюю `web_app` button с одним `NEXT_PUBLIC_APP_URL`.
