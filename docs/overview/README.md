...
- WebApp показывает бейдж `Нужно подтвердить в Telegram`.
...
WebApp не подтверждает и не отменяет сомнительные voice-записи. Подтверждение выполняется только Telegram inline-кнопками под исходным сообщением.
