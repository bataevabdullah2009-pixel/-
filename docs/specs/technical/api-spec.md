...
Бизнес-данные WebApp читаются через Server Components и изменяются Server Actions. Inline update/delete возвращают клиенту structured action state; restore/reset сохраняют redirect-based contract.
