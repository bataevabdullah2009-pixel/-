...
4. Only item `processed` can contribute revenue.
5. Deleted items never contribute revenue.
6. Confirm must not count invalid items.
7. Cancel must not physically delete rows.
