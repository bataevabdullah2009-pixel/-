...
6. Отправить аудио в STT.
7. Получить raw transcript.
8. Очистить текст через LLM.
9. Извлечь позиции продажи через LLM parser.
10. Сохранить данные в Supabase.
11. Ответить продавцу результатом.
