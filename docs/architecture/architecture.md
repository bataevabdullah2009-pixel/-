...
Бизнес-правила продукта, статусов, проверки, подтверждения, отмены и расчёта выручки описаны в [../specs/00-global.md](../specs/00-global.md). Этот документ описывает границы модулей и поток данных.
...
5. Aggregation использует правила выручки из [глобальной спецификации](../specs/00-global.md#17-правила-выручки).
